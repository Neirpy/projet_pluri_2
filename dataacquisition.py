...
saveLandmarks(tosave_gauche, "datas/gauche")
saveLandmarks(tosave_droite, "datas/droite")
saveLandmarks(tosave_tourner_gauche, "datas/tourner_gauche")
saveLandmarks(tosave_tourner_droite, "datas/tourner_droite")
saveLandmarks(tosave_avant, "datas/avant")
saveLandmarks(tosave_arriere, "datas/arriere")
saveLandmarks(tosave_surprise, "datas/surprise")
saveLandmarks(tosave_neutre, "datas/neutre")
saveLandmarks(tosave_tete1, "datas/tete1")
saveLandmarks(tosave_tete2, "datas/tete2")
saveLandmarks(tosave_tete3, "datas/tete3")